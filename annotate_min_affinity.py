...
df = pd.read_excel(working_dir + "merged_rcsb_calls_ffilled_filtered_distance_annotated_affinity_annotation.xlsx")
...
df.to_excel(working_dir + "merged_rcsb_calls_ffilled_filtered_distance_annotated_affinity_annotation_min_value.xlsx", index=False)
